async function ScheduleCardBlock(workflowCtx, portal) {
  return {
    "Step 1": {
...
![Auth GIF](./static/images/auth.gif)
    ...
    "Step 3": {
      name: "Schedule Card Block Request",
      stepCallback: async (stepState) => {
        ...
        return workflowCtx.showEndpoint({
          description:
            "Make a request to AutoRenewal  API",
          endpointPermalink: "$e/Card/ScheduleCardBlock",
          args:{
    ...
    "Step 4": {
      name: "Check Schedule Card Block Status",
      stepCallback: async (stepState) => {
        await portal.setConfig((defaultConfig) => {
          return {
            ...defaultConfig,
        ...
        return workflowCtx.showEndpoint({
          ...
          args:{
            ...
            body: {
              ...
              "PayerNumber": "CZ00000927",
              "Status": "All",
              "RequestedOperation": "UpdateCardStatus", 
              "SortOrder": "1",
              "SearchText": null,
              "CurrentPage": 1,
              "FromDate": "20250601",
