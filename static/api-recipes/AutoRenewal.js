async function AutoRenewal(workflowCtx, portal) {
  return {
    "Step 1": {
...
![Auth GIF](./static/images/auth.gif)
    ...
    "Step 3": {
      name: "Card Auto Renewal Request",
      stepCallback: async (stepState) => {
        ...
        return workflowCtx.showEndpoint({
          ...
          endpointPermalink: "$e/Card/AutoRenew",
          args:{
    ...
    "Step 4": {
      name: "Check Auto Renewal Status",
      stepCallback: async (stepState) => {
        await portal.setConfig((defaultConfig) => {
          return {
            ...defaultConfig,
