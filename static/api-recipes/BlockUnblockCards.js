async function BlockUnblockCards(workflowCtx, portal) {
  return {
    "Step 1": {
...
![Auth GIF](./static/images/auth.gif)
    ...
    "Step 3": {
      ...
      stepCallback: async (stepState) => {
        ...
        return workflowCtx.showEndpoint({
          description:
            "Make a request to update status API",
          endpointPermalink: "$e/Card/CardUpdateStatus",
          args:{
    ...
    "Step 4": {
      name: "Check Block/Unblock Status",
      stepCallback: async (stepState) => {
        await portal.setConfig((defaultConfig) => {
          return {
            ...defaultConfig,
